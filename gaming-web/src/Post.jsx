    ...
    <div className='flex flex-col gap-20 w-full'>
        <div className='flex flex-col gap-5 w-full'>
            <div className='flex items-center gap-5'>
                <img className='w-9 h-9 rounded-full' src='https://i.pinimg.com/1200x/80/18/4b/80184b1da04709d959c58b8f30062156.jpg' alt='team liquid'></img>
                <div>
                    <h2 className='text-[15px] font-semibold'>Team Liquid</h2>
                    <p className='text-[13px] font-light'>18.3.2026</p>
                </div>
            </div>
            <p>Here we win this match with 2 wins in best of 3!</p>
            <div className='flex gap-10 items-center'>
                <div className='flex gap-3 w-2/3 '>
                    <img className='w-full h-72 object-cover rounded-xs' src='https://i.pinimg.com/736x/d8/8d/b9/d88db9865486789974d90382ddc7176b.jpg' alt='team liquid'></img>
                    <div className='flex flex-col gap-3 w-1/3 '>
                        <img className='w-full h-[138px] object-cover rounded-xs' src='https://i.pinimg.com/736x/d3/12/bc/d312bc24469d5c18cca6f8e5dda3987a.jpg' alt='team liquid'></img>
                        <img className='w-full h-[138px] object-cover rounded-xs' src='https://i.pinimg.com/736x/90/f3/0b/90f30b0f8696fe72e4f1116ac82cf76b.jpg' alt='team liquid'></img>
                    </div>
                </div>
                ...
                <div className='bg-gray-800 rounded-md w-1/3 h-full p-5 flex flex-col gap-5'>
                    ...
                    <div className='flex flex-col gap-5 h-40 overflow-y-auto hide-scrollbar'>
                        <div className='flex items-center gap-4'>
                            <img className='w-7 h-7 rounded-full object-cover' src='https://i.pinimg.com/736x/19/d4/ef/19d4efee6534995013f1627764aec075.jpg' alt='rrq hoshi'></img>
                            <div className='flex flex-col gap-1'>
                                <h2 className='text-white text-[9px] font-medium'>Rrq hoshi</h2>
                                <div className='flex items-center gap-1 bg-white rounded-md rounded-tl-none px-2 py-1 w-max relative'>
                                    ...
                                    <p className='text-[13px] text-black font-medium'>I know you can do it!</p>
                                </div>
                            </div>
                        </div>
                        <div className='flex items-center gap-4'>
